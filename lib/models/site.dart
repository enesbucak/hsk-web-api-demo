...
class Site{
  ...
  Site(this.siteId, this.formatAddress, this.address, {this.location, this.name, this.viewport, this.distance, this.poi});
  factory Site.fromJSON(Map<String, dynamic> json){
    return new Site(
        ...
        name: json['name'],
        viewport: CoordinateBounds.fromJSON(json['viewport']),
